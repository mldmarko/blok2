...
namespace Server
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string address2 = "net.tcp://localhost:4001/CertAuth";

            binding2.Security.Transport.ClientCredentialType = TcpClientCredentialType.Certificate;
            ServiceHost host2 = new ServiceHost(typeof(CertAuthServer));
            host2.AddServiceEndpoint(typeof(CertAuth), binding2, address2);
            ...
            //host2.Credentials.ServiceCertificate.Certificate = CertManager.GetCertificateFromFile("TestCA.pfx");
            /// 
            host2.Open();
